...
public:
	...
	/*!Add a number to the spots only if the number is not already there.
		@param spot_ The number we with to include in the bet.
		@return T if number chosen is successfully inserted; F otherwise. */
	bool add_number(number_type spot_);

	/*!Set the amount of money the player is betting.
	...
	/*!Retrives the player's wage on this bet.
	...
	/*!Return a vector< spot_type > with the spots the player has picked sa far.
